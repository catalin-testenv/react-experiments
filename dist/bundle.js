...
},{"./examples/table_performance":465,"babel-polyfill":1}],465:[function(require,module,exports){
'use strict';
...
var App = function (_React$Component) {
    ...
    function App(props) {
        ...
        var _this = _possibleConstructorReturn(this, (_Object$getPrototypeO = Object.getPrototypeOf(App)).call.apply(_Object$getPrototypeO, [this, props].concat(args)));

        _this.regenerate = _this.regenerate.bind(_this);
        _this.state = {
    ...
    _createClass(App, [{
        ...
        key: 'handleOnClick',
        value: function handleOnClick(cellIdx, rowIdx) {
        ...
        value: function render() {
            ...
            var rows = this.state.tableData.map(function (row, i) {
                return React.createElement(Row, { key: i, idx: i, rowData: row });
            });
...
var Table = function (_React$Component2) {
    ...
    function Table(props) {
        ...
        return _possibleConstructorReturn(this, (_Object$getPrototypeO2 = Object.getPrototypeOf(Table)).call.apply(_Object$getPrototypeO2, [this, props].concat(args)));
    }
...
var Row = function (_React$Component3) {
    ...
    function Row(props) {
        ...
        return _possibleConstructorReturn(this, (_Object$getPrototypeO3 = Object.getPrototypeOf(Row)).call.apply(_Object$getPrototypeO3, [this, props].concat(args)));
    }
    ...
    _createClass(Row, [{
        ...
        value: function render() {
            ...
            var cells = Object.keys(rowData).map(function (key, i) {
                return React.createElement(
                    Cell,
                    { key: i, idx: i, rowIdx: _this4.props.idx, textData: rowData[key] },
                    ' ',
                    i,
                    '/',
                    _this4.props.idx,
...
var Cell = function (_React$Component4) {
    ...
    function Cell(props) {
        ...
        var _this5 = _possibleConstructorReturn(this, (_Object$getPrototypeO4 = Object.getPrototypeOf(Cell)).call.apply(_Object$getPrototypeO4, [this, props].concat(args)));
    ...
    _createClass(Cell, [{
        ...
        value: function render() {
            return React.createElement(
                'td',
                { onClick: this.onClick, style: { border: '1px solid gray', padding: '5px' } },
                this.props.textData,
                this.props.children
            );
        }
...
module.exports = function () {
    ReactDOM.render(React.createElement(App, { rowsNum: 400, colsNum: 10 }), document.getElementById('main'));
};
